...
cluster running 64-bit Red Hat Enterprise Linux version 6.x. These
instructions should also work with few modifications on CentOS 6. An
Ubuntu version of this installation guide is available at
...
Tessera stack on a multi-node cluster. It is not focused on tuning and
optimally configuring the Tessera stack. Most components of Tessera
