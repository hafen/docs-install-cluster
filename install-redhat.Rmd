...
This is a guide to installing the DeltaRho stack consisting of Hadoop,
...
DeltaRho stack. It is not focused on tuning and optimally configuring the
DeltaRho stack. It simplifies and generalizes certain aspects of the
...
<http://deltarho.org/docs-install-cluster/install-ubuntu.html>.
